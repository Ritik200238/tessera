...
- Borrow / Repay
- Alert sent (with plain-English copy from Kimi K2)
...
- Out-of-band: Telegram/Discord/email message arrives with Kimi-K2-written copy
...
### Notification copy
- All risk-level copy is generated by Kimi K2 (LLM); fallback to Anthropic Haiku
